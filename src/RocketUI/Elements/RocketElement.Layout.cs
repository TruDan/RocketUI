...
namespace RocketUI
{
    public partial class RocketElement
    {
        ...
        protected internal void DoLayoutSizing()
        {
            ...
            ForEachChild<RocketElement>(c => c.DoLayoutSizing());
        }
        ...
        protected internal void BeginLayoutMeasure()
        {
            ...
            ForEachChild<RocketElement>(c => c.BeginLayoutMeasure());
        }
        ...
        protected internal void BeginLayoutArrange()
        {
            ...
            ForEachChild<RocketElement>(c => c.BeginLayoutArrange());
        }
        ...
        {
            var children = ChildElements.Cast<RocketElement>().ToArray();
        ...
        protected virtual Size MeasureChildrenCore(Size availableSize, IReadOnlyCollection<RocketElement> children)
        {
            Size size = Size.Zero;
        ...
        {
            var children = new ReadOnlyCollection<RocketElement>(ChildElements.Cast<RocketElement>().ToList());

            ArrangeChildrenCore(newBounds, children);
        }

        protected virtual void ArrangeChildrenCore(Rectangle newBounds, IReadOnlyCollection<RocketElement> children)
        {
            foreach (var child in children)
            {
        ...
        protected virtual bool ShouldPositionChild(RocketElement child)
        {
            return true;
        }

        protected LayoutBoundingRectangle PositionChild(RocketElement child,           Alignment alignment,
        ...
        protected virtual void PositionChildCore(RocketElement child, ref LayoutBoundingRectangle bounds, Thickness offset, Alignment  alignment)
        {
            // Arrange Y
